...
```{r, fig.height=12, fig.width=13, warning=FALSE}
## data
df <- dat_child_young
...
plots_arranged <- ggarrange(plotlist = plots, ncol = 3, nrow = 5,  common.legend = TRUE)
plots_arranged
...
path <- paste0('gitignore/figures/plots_arranged.svg')
...
if(file.exists(path) == FALSE){
  tiff(path, width = 8.2, height = 12, units = 'in', res = 400)
...
for (i in 1:nrow(outcomes)) {
  path <- paste0("gitignore/figures/p_", i, ".svg")
